...
| `paraphrase_detection_taskA.py` | `10-1e-05-paraphrase_taskA.pt` | `predictions/para-dev-output_taskA.csv` | `predictions/para-test-output_taskA.csv` |
| `paraphrase_detection_taskB.py` | `10-1e-05-paraphrase_taskB.pt` | `predictions/para-dev-output_taskB.csv` | `predictions/para-test-output_taskB.csv` |
| `paraphrase_detection_taskC.py` | `10-1e-05-paraphrase_taskC.pt` | `predictions/para-dev-output_taskC.csv` | `predictions/para-test-output_taskC.csv` |
```
